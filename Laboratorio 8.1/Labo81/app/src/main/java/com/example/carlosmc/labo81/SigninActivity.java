    ...
    protected String doInBackground(String... arg0) {
        ...
        if(byGetOrPost == 0){
            try{
                ...
                String link = "http://movilesunicm.esy.es/laboratorio8/methodGET.php usuario="+username+"&clave="+password;
            ...
            try{
                String username = (String)arg0[0];
                String password = (String)arg0[1];
                String link = "http://movilesunicm.esy.es/laboratorio8/methodPOST.php";
